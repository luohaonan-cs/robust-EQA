...
import pdb
import random
from loss_noise import loss_coteaching
    ...
    while epoch < int(args.max_epochs):
        ...
        if args.input_type == 'ques':
            for batch in eval_loader:
                ...
                metrics.update([loss.data.item(), accuracy, ranks, 1.0 / ranks])
        ...
        if args.input_type == 'ques':
            ...
            while done == False:
                ...
                for batch in train_loader:
                    ...
                    loss, loss1 = loss_coteaching(scores, scores1, answers_var, rate_schedule[epoch])
...
if __name__ == '__main__':
    ...
    if args.input_type == 'ques':
        ...
        # shared_model1 = VqaLstmCnnAttentionModel(**model_kwargs)
    if args.checkpoint_path != False:
    ...
    if args.mode == 'eval':
        ...
        p = mp.Process(target=eval, args=(1, args, shared_model))
        p.start()
        processes.append(p)
